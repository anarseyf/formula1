...
ggplot() +
  ...
  geom_point(
    data = race_by_race,
    aes(x = round + offset_middle, y = year, fill = won_by, color = won_by),
    shape = 21,
    size = 3
  ) +
  rivals_color_scale +
  ...
  geom_label(
    data = champion_table,
    aes(x = offset_left - 2, y = year, label = count),
    size = 5,
    family = "mono"
  ) +
  geom_text(
    data = stats_table,
    mapping = aes(x = offset_middle - 8, y = year, label = champion_wins),
    hjust = "left",
    family = "mono"
  ) +
  geom_point(
    data = champion_names,
    aes(x = offset_middle - 6, y = year),
    shape = 21,
    size = 3,
    fill = champion_color,
    color = champion_color
  ...
  geom_text(
    data = stats_table,
    mapping = aes(x = offset_right - 7, y = year, label = runnerup_wins),
    hjust = "left",
    family = "mono"
  ) +
  geom_point(
    data = runnerup_names,
    aes(x = offset_right - 5, y = year),
    shape = 21,
    size = 3,
    fill = runnerup_color,
    color = runnerup_color
  ...
  scale_x_continuous(expand = c(0, 0), limits = c(-35, 30))
```
