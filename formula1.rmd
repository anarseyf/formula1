...
pole_sitters %>%
  filter(raceId %in% s2001$raceId)

# results_wins <- results_wins %>%
#   inner_join(pole_sitters, by = "raceId")
...
# geom_point(
#   data = subset(results_wins, polesitterId == championId),
