...
```{r main, fig.width=12, fig.height=17, out.width="100%"}
...
ggplot() +
  ...
  scale_fill_manual(values = c("white", "#e9e9e9")) +
  new_scale_fill() +
  # Titles
  geom_label(
    data = titles_table,
  ...
  geom_vline(xintercept = verticals - 0.5, color = "#6e6e6e", size = 0.25) +
  geom_hline(yintercept = seq(min_year, max_year), color = "#6e6e6e", size = 0.25, linetype = "dotted")
